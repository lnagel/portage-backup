...
pkg_postinst(){
	...
	[[ -z $(ls "${ROOT}"/sys/block/*/device/unload_heads 2>/dev/null) ]] && \
		ewarn "Your kernel does NOT support shock protection. Kernel 2.5.28 and above is recommended!"
	...
	elog "You might need to enable shock protection manually by running echo -1 > /sys/block/sda/device/unload_heads"
}
